...
/*
    ...
    후입선출:LIFO, Last In First Out 은 나중에 저장된 객체를 먼저 꺼내오는 자료구조이고
    반대로 선입선출:FIFO, First In Fisrt Out 은 먼저 저장된 객체가 먼저 꺼내지는 자료구조를 말한다.
    
    컬렉션프레임워크에는 LIFO자료구조를 지원하는 Stack클래스와 FIFO자료구조를 지원하는 Queue 인터페이스를 지원한다.
