...
/*
    ...
    인터페이스 간에도 상속이 있기 때문에 부모인터페이스에 디폴트메서드가 정의되어 있는 경우
    자식 인터페이스에서 디폴트메서드를 사용하는 방법은 3가지가 있다.
    
    1. 디폴트메서드를 단순히 상속만 받는 경우
    2. 디폴트메서드를 재정의 하는 경우
    3. 디폴트메서드를 추상메서드로 재선언 하는 경우
*/
...
public class DefaultExtendsMain {
	...
	public static void main(String[] args) {
		...
		ci3.method2();  // child3 parent.method2 디폴트메서드를 추상메서드로 재선언
