...
/*
    ...
    List, Set, Map 컬렉션을 사용하는 것이 아닌 사용자가 만든 컨테이너.
    즉, 사용자가 정의한 컬력센으로 stream을 저장하는 방법
    
    stream은 요소들을 필터링 or 매핑하여 사용자가 정의한 컨테이너에 요소들을 저장할 수 있도록
    collect()메서드를 이용해서 사용자 정의 컨테이너에 저장할 수 있다.
*/
...
//								 .collect(() -> new MaleStudent(), (m, s) -> m.accumulate(s), (m1, m2) -> m1.combine(m2));
		...
		// 5) BiConsumer<MaleStudent, MaleStudent> combine = (m, t) -> m1.combine(m2)
